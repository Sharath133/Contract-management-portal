      ...
      <Container maxW={"3xl"}>
        ...
        >
          <Heading
            ...
            lineHeight={"110%"}
          >
            Secure Public Money with <br />
            <Text as={"span"} color={"green.400"}>
              your Responses
            </Text>
          </Heading>
          <Text color={"gray.500"}>
            We are a group of students giving our best to ensure transparent and
            clear administration of the tendering services.
          </Text>
          <Stack
            direction={"column"}
            spacing={3}
